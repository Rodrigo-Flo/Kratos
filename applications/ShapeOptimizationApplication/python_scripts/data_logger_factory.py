...
from .value_logger_augmented_lagrange import ValueLoggerAugmentedLagrange
...
class DataLogger():
    ...
    def __CreateValueLogger( self ):
        ...
        elif AlgorithmName == "augmented_lagrange":
            return ValueLoggerAugmentedLagrange( self.Communicator, self.OptimizationSettings )
        else:
